    ...
    <div className="h-[422px] w-[378.56px] cursor-pointer hover:shadow-md hover:rounded-lg ">
      ...
      <div className="flex justify-between mt-4">
        <div className=" grid grid-cols-3 border w-[156px] rounded-full px-2 py-1">
          <div className="flex items-center">
            <!-- svg and text omitted here for brevity in this message; keep the svg blocks from your provided code -->
          </div>
          <!-- rest of the grid cells and price block (keep the content you pasted) -->
        </div>
